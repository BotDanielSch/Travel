...
class MainWidget(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        # print("INIT - W:", self.width, "INIT H:", self.height)
    ...
    def is_desktop(self):
        if platform in ("Linux", "win", "maxos"):
            return True
        return False
    ...
    def on_size(self, widget, parent):
        print("ON SIZE - W:", self.width, "INIT H:", self.height)
    ...
    def transform_perspective(self, x, y):
        ...
        factor_y = diff_y / self.perspective_point_y # 1 when diff_y == self.perspective
